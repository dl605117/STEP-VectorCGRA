...
// PyMTL BitStruct InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d Definition
typedef struct packed {
  logic [1:0] src;
  logic [1:0] dst;
  logic [1:0] src_x;
...
} InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d;

// PyMTL BitStruct IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 Definition
typedef struct packed {
  logic [2:0] src;
  logic [2:0] dst;
  ...
  logic [0:0] vc_id;
  MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05 payload;
} IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902;

// PyMTL BitStruct ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e Definition
typedef struct packed {
  logic [0:0] dst;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d inter_cgra_pkt;
} ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e;

// PyMTL BitStruct TileSramXbarPacket_4_3_128__1370121529e22979 Definition
typedef struct packed {
  logic [1:0] src;
  logic [1:0] dst;
  logic [6:0] addr;
  logic [1:0] src_cgra;
  logic [2:0] src_tile;
} TileSramXbarPacket_4_3_128__1370121529e22979;
...
// Full name: Mux__Type_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__ninputs_2
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__48c7597d5717662d
(
  input  logic [0:0] clk ,
  input  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d in_ [0:1],
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d out ,
...
// Full name: BypassQueue1EntryRTL__EntryType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueue1EntryRTL__f4283929d6405410
(
  input  logic [0:0] clk ,
  output logic [0:0] count ,
  input  logic [0:0] reset ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send__msg  ,
  input logic [0:0] send__rdy  ,
  output logic [0:0] send__val  
);
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d entry;
  logic [0:0] full;
  //-------------------------------------------------------------
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d bypass_mux__in_ [0:1];
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d bypass_mux__out;
  logic [0:0] bypass_mux__reset;
  logic [0:0] bypass_mux__sel;

  Mux__48c7597d5717662d bypass_mux
  (
    .clk( bypass_mux__clk ),
    .in_( bypass_mux__in_ ),
    .out( bypass_mux__out ),
...
// Full name: BypassQueueRTL__EntryType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__num_entries_1
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueRTL__5c8459ccf9891016
(
  input  logic [0:0] clk ,
  output logic [0:0] count ,
  input  logic [0:0] reset ,
  ...
  logic [0:0] q__count;
  logic [0:0] q__reset;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d q__recv__msg;
  logic [0:0] q__recv__rdy;
  logic [0:0] q__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d q__send__msg;
  logic [0:0] q__send__rdy;
  logic [0:0] q__send__val;

  BypassQueue1EntryRTL__f4283929d6405410 q
  (
    .clk( q__clk ),
    .count( q__count ),
    .reset( q__reset ),
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__ninputs_2
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__3455a577ffdbfaf8
(
  input  logic [0:0] clk ,
  input  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e in_ [0:1],
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e out ,
  input  logic [0:0] reset ,
  input  logic [0:0] sel 
);
...
// Full name: RegisterFile__Type_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__nregs_2__rd_ports_1__wr_ports_1__const_zero_False
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/register_files.py

module RegisterFile__c1f84ad649da9ade
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e wdata [0:0],
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e regs [0:1];
...
// Full name: BypassQueueDpathRTL__EntryType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueDpathRTL__3465e6274a7d4a82
(
  input  logic [0:0] clk ,
  input  logic [0:0] mux_sel ,
  input  logic [0:0] raddr ,
  input  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv_msg ,
  input  logic [0:0] reset ,
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e send_msg ,
  ...
  logic [0:0] mux__clk;
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e mux__in_ [0:1];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e mux__out;
  logic [0:0] mux__reset;
  logic [0:0] mux__sel;

  Mux__3455a577ffdbfaf8 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e rf__rdata [0:0];
  logic [0:0] rf__reset;
  logic [0:0] rf__waddr [0:0];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e rf__wdata [0:0];
  logic [0:0] rf__wen [0:0];

  RegisterFile__c1f84ad649da9ade rf
  (
    .clk( rf__clk ),
    .raddr( rf__raddr ),
    .rdata( rf__rdata ),
...
// PyMTL Component BypassQueueRTL Definition
// Full name: BypassQueueRTL__EntryType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueRTL__3465e6274a7d4a82
(
  input  logic [0:0] clk ,
  output logic [1:0] count ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e send__msg  ,
  input logic [0:0] send__rdy  ,
  output logic [0:0] send__val  
);
  //-------------------------------------------------------------
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e dpath__recv_msg;
  logic [0:0] dpath__reset;
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__3465e6274a7d4a82 dpath
  (
    .clk( dpath__clk ),
...
// Full name: InputUnitRTL__PacketType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__QueueType_BypassQueueRTL
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/InputUnitRTL.py

module InputUnitRTL__5e13a012775b870e
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg  ,
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e queue__recv__msg;
  logic [0:0] queue__recv__rdy;
  logic [0:0] queue__recv__val;
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e queue__send__msg;
  logic [0:0] queue__send__rdy;
  logic [0:0] queue__send__val;

  BypassQueueRTL__3465e6274a7d4a82 queue
  (
    .clk( queue__clk ),
    .count( queue__count ),
    .reset( queue__reset ),
...
// Full name: OutputUnitRTL__PacketType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__QueueType_None
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/OutputUnitRTL.py

module OutputUnitRTL__89ab4399664389a5
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg  ,
...
// Full name: XbarRouteUnitRTL__PacketType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__num_outports_1
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/xbar/XbarRouteUnitRTL.py

module XbarRouteUnitRTL__14283546de7a37b3
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e send__msg [0:0] ,
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__ninputs_5
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__2912ec6bafe1abf9
(
  input  logic [0:0] clk ,
  input  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e in_ [0:4],
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e out ,
  input  logic [0:0] reset ,
  input  logic [2:0] sel 
);
...
// Full name: SwitchUnitRTL__PacketType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__num_inports_5
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/SwitchUnitRTL.py

module SwitchUnitRTL__4d2cf802345aee3a
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg [0:4] ,
  ...
  logic [0:0] mux__clk;
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e mux__in_ [0:4];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e mux__out;
  logic [0:0] mux__reset;
  logic [2:0] mux__sel;

  Mux__2912ec6bafe1abf9 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
...
// Full name: XbarBypassQueueRTL__PacketType_ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e__num_inports_5__num_outports_1__InputUnitType_InputUnitRTL__RouteUnitType_XbarRouteUnitRTL__SwitchUnitType_SwitchUnitRTL__OutputUnitType_OutputUnitRTL
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/xbar/XbarBypassQueueRTL.py

module XbarBypassQueueRTL__db195ae01e468cb5
(
  input  logic [0:0] clk ,
  output ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e packet_on_input_units [0:4],
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e recv__msg [0:4] ,
  output logic [0:0] recv__rdy [0:4] ,
  input logic [0:0] recv__val [0:4] ,
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e input_units__recv__msg [0:4];
  logic [0:0] input_units__recv__rdy [0:4];
  logic [0:0] input_units__recv__val [0:4];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e input_units__send__msg [0:4];
  logic [0:0] input_units__send__rdy [0:4];
  logic [0:0] input_units__send__val [0:4];

  InputUnitRTL__5e13a012775b870e input_units__0
  (
  ...
  InputUnitRTL__5e13a012775b870e input_units__1
  (
  ...
  InputUnitRTL__5e13a012775b870e input_units__2
  (
  ...
  InputUnitRTL__5e13a012775b870e input_units__3
  (
  ...
  InputUnitRTL__5e13a012775b870e input_units__4
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e output_units__recv__msg [0:0];
  logic [0:0] output_units__recv__rdy [0:0];
  logic [0:0] output_units__recv__val [0:0];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e output_units__send__msg [0:0];
  logic [0:0] output_units__send__rdy [0:0];
  logic [0:0] output_units__send__val [0:0];

  OutputUnitRTL__89ab4399664389a5 output_units__0
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e route_units__recv__msg [0:4];
  logic [0:0] route_units__recv__rdy [0:4];
  logic [0:0] route_units__recv__val [0:4];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e route_units__send__msg [0:4][0:0];
  logic [0:0] route_units__send__rdy [0:4][0:0];
  logic [0:0] route_units__send__val [0:4][0:0];

  XbarRouteUnitRTL__14283546de7a37b3 route_units__0
  (
  ...
  XbarRouteUnitRTL__14283546de7a37b3 route_units__1
  (
  ...
  XbarRouteUnitRTL__14283546de7a37b3 route_units__2
  (
  ...
  XbarRouteUnitRTL__14283546de7a37b3 route_units__3
  (
  ...
  XbarRouteUnitRTL__14283546de7a37b3 route_units__4
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e switch_units__recv__msg [0:0][0:4];
  logic [0:0] switch_units__recv__rdy [0:0][0:4];
  logic [0:0] switch_units__recv__val [0:0][0:4];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e switch_units__send__msg [0:0];
  logic [0:0] switch_units__send__rdy [0:0];
  logic [0:0] switch_units__send__val [0:0];

  SwitchUnitRTL__4d2cf802345aee3a switch_units__0
  (
...
// PyMTL Component RegisterFile Definition
// Full name: RegisterFile__Type_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__nregs_2__rd_ports_1__wr_ports_1__const_zero_False
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/register_files.py

module RegisterFile__7b2f5802bcbc1b89
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 wdata [0:0],
  input  logic [0:0] wen [0:0]
);
  localparam logic [0:0] __const__rd_ports_at_up_rf_read  = 1'd1;
  localparam logic [0:0] __const__wr_ports_at_up_rf_write  = 1'd1;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 regs [0:1];
...
// Full name: NormalQueueDpathRTL__EntryType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module NormalQueueDpathRTL__42e19db10df79104
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr ,
  input  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_msg ,
  input  logic [0:0] reset ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_msg ,
  input  logic [0:0] waddr ,
  input  logic [0:0] wen 
);
  //-------------------------------------------------------------
  ...
  logic [0:0] rf__clk;
  logic [0:0] rf__raddr [0:0];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 rf__rdata [0:0];
  logic [0:0] rf__reset;
  logic [0:0] rf__waddr [0:0];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 rf__wdata [0:0];
  logic [0:0] rf__wen [0:0];

  RegisterFile__7b2f5802bcbc1b89 rf
  (
    .clk( rf__clk ),
    .raddr( rf__raddr ),
    .rdata( rf__rdata ),
...
// Full name: NormalQueueRTL__EntryType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module NormalQueueRTL__42e19db10df79104
(
  input  logic [0:0] clk ,
  output logic [1:0] count ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send__msg  ,
  input logic [0:0] send__rdy  ,
  output logic [0:0] send__val  
);
  //-------------------------------------------------------------
  ...
  logic [0:0] dpath__clk;
  logic [0:0] dpath__raddr;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 dpath__recv_msg;
  logic [0:0] dpath__reset;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  NormalQueueDpathRTL__42e19db10df79104 dpath
  (
    .clk( dpath__clk ),
    .raddr( dpath__raddr ),
    .recv_msg( dpath__recv_msg ),
...
// PyMTL Component RegisterFile Definition
// Full name: RegisterFile__Type_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__nregs_2__rd_ports_1__wr_ports_1__const_zero_False
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/register_files.py

module RegisterFile__e9ecdcaa4bbc05c6
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d wdata [0:0],
  input  logic [0:0] wen [0:0]
);
  localparam logic [0:0] __const__rd_ports_at_up_rf_read  = 1'd1;
  localparam logic [0:0] __const__wr_ports_at_up_rf_write  = 1'd1;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d regs [0:1];
...
// PyMTL Component NormalQueueDpathRTL Definition
// Full name: NormalQueueDpathRTL__EntryType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module NormalQueueDpathRTL__2d2966f6fb6f3dd7
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr ,
  input  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_msg ,
  input  logic [0:0] reset ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_msg ,
  input  logic [0:0] waddr ,
  input  logic [0:0] wen 
);
  //-------------------------------------------------------------
  ...
  logic [0:0] rf__clk;
  logic [0:0] rf__raddr [0:0];
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d rf__rdata [0:0];
  logic [0:0] rf__reset;
  logic [0:0] rf__waddr [0:0];
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d rf__wdata [0:0];
  logic [0:0] rf__wen [0:0];

  RegisterFile__e9ecdcaa4bbc05c6 rf
  (
    .clk( rf__clk ),
    .raddr( rf__raddr ),
    .rdata( rf__rdata ),
...
// PyMTL Component NormalQueueRTL Definition
// Full name: NormalQueueRTL__EntryType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module NormalQueueRTL__2d2966f6fb6f3dd7
(
  input  logic [0:0] clk ,
  output logic [1:0] count ,
  input  logic [0:0] reset ,
  ...
  logic [0:0] dpath__clk;
  logic [0:0] dpath__raddr;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d dpath__recv_msg;
  logic [0:0] dpath__reset;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  NormalQueueDpathRTL__2d2966f6fb6f3dd7 dpath
  (
    .clk( dpath__clk ),
    .raddr( dpath__raddr ),
    .recv_msg( dpath__recv_msg ),
...
// Full name: ChannelRTL__PacketType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__QueueType_NormalQueueRTL__latency_1
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/channel/ChannelRTL.py

module ChannelRTL__5d22ca0608d63fbd
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv__msg  ,
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d queues__recv__msg [0:0];
  logic [0:0] queues__recv__rdy [0:0];
  logic [0:0] queues__recv__val [0:0];
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d queues__send__msg [0:0];
  logic [0:0] queues__send__rdy [0:0];
  logic [0:0] queues__send__val [0:0];

  NormalQueueRTL__2d2966f6fb6f3dd7 queues__0
  (
    .clk( queues__clk[0] ),
...
// Full name: ControllerRTL__CgraIdType_Bits2__IntraCgraPktType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__InterCgraPktType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__DataAddrType_Bits7__multi_cgra_rows_1__multi_cgra_columns_4__num_tiles_4__controller2addr_map_{0: [0, 31], 1: [32, 63], 2: [64, 95], 3: [96, 127]}__idTo2d_map_{0: [0, 0], 1: [1, 0], 2: [2, 0], 3: [3, 0]}
// At /home/jovank/STEP-VectorCGRA/controller/ControllerRTL.py

module ControllerRTL__cb7ec46bb4dde248
(
  input  logic [1:0] cgra_id ,
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_from_cpu_pkt__msg  ,
  output logic [0:0] recv_from_cpu_pkt__rdy  ,
  input logic [0:0] recv_from_cpu_pkt__val  ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_from_ctrl_ring_pkt__msg  ,
  output logic [0:0] recv_from_ctrl_ring_pkt__rdy  ,
  input logic [0:0] recv_from_ctrl_ring_pkt__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_inter_cgra_noc__msg  ,
  output logic [0:0] recv_from_inter_cgra_noc__rdy  ,
  input logic [0:0] recv_from_inter_cgra_noc__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_request_pkt__msg  ,
  output logic [0:0] recv_from_tile_load_request_pkt__rdy  ,
  input logic [0:0] recv_from_tile_load_request_pkt__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_response_pkt__msg  ,
  output logic [0:0] recv_from_tile_load_response_pkt__rdy  ,
  input logic [0:0] recv_from_tile_load_response_pkt__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_store_request_pkt__msg  ,
  output logic [0:0] recv_from_tile_store_request_pkt__rdy  ,
  input logic [0:0] recv_from_tile_store_request_pkt__val  ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_to_cpu_pkt__msg  ,
  input logic [0:0] send_to_cpu_pkt__rdy  ,
  output logic [0:0] send_to_cpu_pkt__val  ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_to_ctrl_ring_pkt__msg  ,
  input logic [0:0] send_to_ctrl_ring_pkt__rdy  ,
  output logic [0:0] send_to_ctrl_ring_pkt__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_inter_cgra_noc__msg  ,
  input logic [0:0] send_to_inter_cgra_noc__rdy  ,
  output logic [0:0] send_to_inter_cgra_noc__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_load_request__msg  ,
  input logic [0:0] send_to_mem_load_request__rdy  ,
  output logic [0:0] send_to_mem_load_request__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_store_request__msg  ,
  input logic [0:0] send_to_mem_store_request__rdy  ,
  output logic [0:0] send_to_mem_store_request__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_tile_load_response__msg  ,
  ...
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e crossbar__packet_on_input_units [0:4];
  logic [0:0] crossbar__reset;
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e crossbar__recv__msg [0:4];
  logic [0:0] crossbar__recv__rdy [0:4];
  logic [0:0] crossbar__recv__val [0:4];
  ControllerNocXbarPacket_InterCgraPktType__35bbd6c676160f8e crossbar__send__msg [0:0];
  logic [0:0] crossbar__send__rdy [0:0];
  logic [0:0] crossbar__send__val [0:0];

  XbarBypassQueueRTL__db195ae01e468cb5 crossbar
  (
    .clk( crossbar__clk ),
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_from_cpu_pkt_queue__recv__msg;
  logic [0:0] recv_from_cpu_pkt_queue__recv__rdy;
  logic [0:0] recv_from_cpu_pkt_queue__recv__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_from_cpu_pkt_queue__send__msg;
  logic [0:0] recv_from_cpu_pkt_queue__send__rdy;
  logic [0:0] recv_from_cpu_pkt_queue__send__val;

  NormalQueueRTL__42e19db10df79104 recv_from_cpu_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_request_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_load_request_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_load_request_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_request_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_load_request_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_load_request_pkt_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd recv_from_tile_load_request_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_response_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_load_response_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_load_response_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_load_response_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_load_response_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_load_response_pkt_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd recv_from_tile_load_response_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_store_request_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_store_request_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_store_request_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_tile_store_request_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_store_request_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_store_request_pkt_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd recv_from_tile_store_request_pkt_queue
  (
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_to_cpu_pkt_queue__recv__msg;
  logic [0:0] send_to_cpu_pkt_queue__recv__rdy;
  logic [0:0] send_to_cpu_pkt_queue__recv__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_to_cpu_pkt_queue__send__msg;
  logic [0:0] send_to_cpu_pkt_queue__send__rdy;
  logic [0:0] send_to_cpu_pkt_queue__send__val;

  NormalQueueRTL__42e19db10df79104 send_to_cpu_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_load_request_queue__recv__msg;
  logic [0:0] send_to_mem_load_request_queue__recv__rdy;
  logic [0:0] send_to_mem_load_request_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_load_request_queue__send__msg;
  logic [0:0] send_to_mem_load_request_queue__send__rdy;
  logic [0:0] send_to_mem_load_request_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd send_to_mem_load_request_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_store_request_queue__recv__msg;
  logic [0:0] send_to_mem_store_request_queue__recv__rdy;
  logic [0:0] send_to_mem_store_request_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_mem_store_request_queue__send__msg;
  logic [0:0] send_to_mem_store_request_queue__send__rdy;
  logic [0:0] send_to_mem_store_request_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd send_to_mem_store_request_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_tile_load_response_queue__recv__msg;
  logic [0:0] send_to_tile_load_response_queue__recv__rdy;
  logic [0:0] send_to_tile_load_response_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_tile_load_response_queue__send__msg;
  logic [0:0] send_to_tile_load_response_queue__send__rdy;
  logic [0:0] send_to_tile_load_response_queue__send__val;

  ChannelRTL__5d22ca0608d63fbd send_to_tile_load_response_queue
  (
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d __tmpvar__update_received_msg_received_pkt;
  ...
  always_comb begin : update_received_msg
    ...
    send_to_cpu_pkt_queue__recv__msg = { 3'd0, 3'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 153'd0 };
    ...
    crossbar__recv__msg[__tmpvar__update_received_msg_kFromCpuCtrlAndDataIdx] = { 1'd0, { cgra_id, recv_from_cpu_pkt_queue__send__msg.dst_cgra_id, 2'd0, 1'd0, idTo2d_x_lut[recv_from_cpu_pkt_queue__send__msg.dst_cgra_id], idTo2d_y_lut[recv_from_cpu_pkt_queue__send__msg.dst_cgra_id], 3'( __const__num_tiles_at_update_received_msg ), recv_from_cpu_pkt_queue__send__msg.dst, 8'd0, 2'd0, recv_from_cpu_pkt_queue__send__msg.payload } };
    ...
    send_to_mem_load_request_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, 153'd0 };
    send_to_mem_store_request_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, 153'd0 };
    send_to_tile_load_response_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, 153'd0 };
    recv_from_inter_cgra_noc__rdy = 1'd0;
    send_to_ctrl_ring_pkt__val = 1'd0;
    send_to_ctrl_ring_pkt__msg = { 3'd0, 3'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 153'd0 };
...
// Full name: RecvRTL2CreditSendRTL__MsgType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__vc_2__credit_line_2
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/ocnlib/ifcs/CreditIfc.py

module RecvRTL2CreditSendRTL__f39815b882a5984d
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg  ,
...
// Full name: InputUnitCreditRTL__PacketType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__QueueType_NormalQueueRTL__vc_2__credit_line_2
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/InputUnitCreditRTL.py

module InputUnitCreditRTL__b0e0cf1f09856542
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send__msg [0:1] ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 buffers__recv__msg [0:1];
  logic [0:0] buffers__recv__rdy [0:1];
  logic [0:0] buffers__recv__val [0:1];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 buffers__send__msg [0:1];
  logic [0:0] buffers__send__rdy [0:1];
  logic [0:0] buffers__send__val [0:1];

  NormalQueueRTL__42e19db10df79104 buffers__0
  (
    .clk( buffers__clk[0] ),
  ...
  NormalQueueRTL__42e19db10df79104 buffers__1
  (
    .clk( buffers__clk[1] ),
...
// Full name: OutputUnitCreditRTL__MsgType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__vc_2__credit_line_2
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/OutputUnitCreditRTL.py

module OutputUnitCreditRTL__f39815b882a5984d
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg  ,
...
// Full name: RingRouteUnitRTL__PacketType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__PositionType_Bits3__num_routers_5
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/ringnet/RingRouteUnitRTL.py

module RingRouteUnitRTL__19e32d96f56f2ed8
(
  input  logic [0:0] clk ,
  input  logic [2:0] pos ,
  input  logic [0:0] reset ,
  ...
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send__msg [0:2] ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_msg_wire;
  logic [2:0] send_rdy;
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__ninputs_6
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__77b3e2b339daaa64
(
  input  logic [0:0] clk ,
  input  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 in_ [0:5],
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 out ,
  input  logic [0:0] reset ,
  input  logic [2:0] sel 
);
...
// PyMTL Component SwitchUnitRTL Definition
// Full name: SwitchUnitRTL__PacketType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__num_inports_6
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/SwitchUnitRTL.py

module SwitchUnitRTL__dba7adef76ed0387
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg [0:5] ,
  ...
  logic [0:0] mux__clk;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 mux__in_ [0:5];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 mux__out;
  logic [0:0] mux__reset;
  logic [2:0] mux__sel;

  Mux__77b3e2b339daaa64 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
...
// Full name: RingRouterRTL__PacketType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__PositionType_Bits3__num_routers_5__InputUnitType_InputUnitCreditRTL__RouteUnitType_RingRouteUnitRTL__SwitchUnitType_SwitchUnitRTL__OutputUnitType_OutputUnitCreditRTL__vc_2__credit_line_2
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/ringnet/RingRouterRTL.py

module RingRouterRTL__026f281edb6eacb0
(
  input  logic [0:0] clk ,
  input  logic [2:0] pos ,
  input  logic [0:0] reset ,
  input logic [0:0] recv__en [0:2] ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg [0:2] ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 input_units__recv__msg [0:2];
  logic [0:0] input_units__recv__yum [0:2][0:1];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 input_units__send__msg [0:2][0:1];
  logic [0:0] input_units__send__rdy [0:2][0:1];
  logic [0:0] input_units__send__val [0:2][0:1];

  InputUnitCreditRTL__b0e0cf1f09856542 input_units__0
  (
    .clk( input_units__clk[0] ),
    .reset( input_units__reset[0] ),
  ...
  InputUnitCreditRTL__b0e0cf1f09856542 input_units__1
  (
    .clk( input_units__clk[1] ),
    .reset( input_units__reset[1] ),
  ...
  InputUnitCreditRTL__b0e0cf1f09856542 input_units__2
  (
    .clk( input_units__clk[2] ),
    .reset( input_units__reset[2] ),
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 output_units__recv__msg [0:2];
  logic [0:0] output_units__recv__rdy [0:2];
  logic [0:0] output_units__recv__val [0:2];
  logic [0:0] output_units__send__en [0:2];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 output_units__send__msg [0:2];
  logic [0:0] output_units__send__yum [0:2][0:1];

  OutputUnitCreditRTL__f39815b882a5984d output_units__0
  (
    .clk( output_units__clk[0] ),
    .reset( output_units__reset[0] ),
    .recv__msg( output_units__recv__msg[0] ),
  ...
  OutputUnitCreditRTL__f39815b882a5984d output_units__1
  (
  ...
  OutputUnitCreditRTL__f39815b882a5984d output_units__2
  (
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 route_units__recv__msg [0:5];
  logic [0:0] route_units__recv__rdy [0:5];
  logic [0:0] route_units__recv__val [0:5];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 route_units__send__msg [0:5][0:2];
  logic [0:0] route_units__send__rdy [0:5][0:2];
  logic [0:0] route_units__send__val [0:5][0:2];

  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__0
  (
    .clk( route_units__clk[0] ),
  ...
  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__1
  (
    .clk( route_units__clk[1] ),
  ...
  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__2
  (
    .clk( route_units__clk[2] ),
  ...
  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__3
  (
    .clk( route_units__clk[3] ),
  ...
  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__4
  (
    .clk( route_units__clk[4] ),
  ...
  RingRouteUnitRTL__19e32d96f56f2ed8 route_units__5
  (
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 switch_units__recv__msg [0:2][0:5];
  logic [0:0] switch_units__recv__rdy [0:2][0:5];
  logic [0:0] switch_units__recv__val [0:2][0:5];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 switch_units__send__msg [0:2];
  logic [0:0] switch_units__send__rdy [0:2];
  logic [0:0] switch_units__send__val [0:2];

  SwitchUnitRTL__dba7adef76ed0387 switch_units__0
  (
    .clk( switch_units__clk[0] ),
    .reset( switch_units__reset[0] ),
    .recv__msg( switch_units__recv__msg[0] ),
  ...
  SwitchUnitRTL__dba7adef76ed0387 switch_units__1
  (
  ...
  SwitchUnitRTL__dba7adef76ed0387 switch_units__2
  (
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__ninputs_2
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__032b278af49b8beb
(
  input  logic [0:0] clk ,
  input  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 in_ [0:1],
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 out ,
  input  logic [0:0] reset ,
  input  logic [0:0] sel 
);
...
// PyMTL Component BypassQueueDpathRTL Definition
// Full name: BypassQueueDpathRTL__EntryType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueDpathRTL__42e19db10df79104
(
  input  logic [0:0] clk ,
  input  logic [0:0] mux_sel ,
  input  logic [0:0] raddr ,
  ...
  logic [0:0] mux__clk;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 mux__in_ [0:1];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 mux__out;
  logic [0:0] mux__reset;
  logic [0:0] mux__sel;

  Mux__032b278af49b8beb mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
...
// PyMTL Component BypassQueueRTL Definition
// Full name: BypassQueueRTL__EntryType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueRTL__42e19db10df79104
(
  input  logic [0:0] clk ,
  output logic [1:0] count ,
  input  logic [0:0] reset ,
  ...
  BypassQueueDpathRTL__42e19db10df79104 dpath
  (
    .clk( dpath__clk ),
    .mux_sel( dpath__mux_sel ),
    .raddr( dpath__raddr ),
...
// Full name: CreditRecvRTL2SendRTL__MsgType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__vc_2__credit_line_2__QType_BypassQueueRTL
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/ocnlib/ifcs/CreditIfc.py

module CreditRecvRTL2SendRTL__595340bae1c07585
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input logic [0:0] recv__en  ,
  ...
  BypassQueueRTL__42e19db10df79104 buffers__0
  (
    .clk( buffers__clk[0] ),
    .count( buffers__count[0] ),
    .reset( buffers__reset[0] ),
  ...
  BypassQueueRTL__42e19db10df79104 buffers__1
  (
    .clk( buffers__clk[1] ),
    .count( buffers__count[1] ),
    .reset( buffers__reset[1] ),
...
// Full name: RingNetworkRTL__PacketType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__PositionType_Bits3__num_routers_5__chl_lat_1__vc_2__credit_line_2
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/ringnet/RingNetworkRTL.py

module RingNetworkRTL__40fc70d68ad976a2
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv__msg [0:4] ,
  output logic [0:0] recv__rdy [0:4] ,
  input logic [0:0] recv__val [0:4] ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send__msg [0:4] ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_adp__recv__msg [0:4];
  logic [0:0] recv_adp__recv__rdy [0:4];
  logic [0:0] recv_adp__recv__val [0:4];
  logic [0:0] recv_adp__send__en [0:4];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_adp__send__msg [0:4];
  logic [0:0] recv_adp__send__yum [0:4][0:1];

  RecvRTL2CreditSendRTL__f39815b882a5984d recv_adp__0
  (
    .clk( recv_adp__clk[0] ),
  ...
  RecvRTL2CreditSendRTL__f39815b882a5984d recv_adp__1
  (
    .clk( recv_adp__clk[1] ),
  ...
  RecvRTL2CreditSendRTL__f39815b882a5984d recv_adp__2
  (
    .clk( recv_adp__clk[2] ),
  ...
  RecvRTL2CreditSendRTL__f39815b882a5984d recv_adp__3
  (
    .clk( recv_adp__clk[3] ),
  ...
  RecvRTL2CreditSendRTL__f39815b882a5984d recv_adp__4
  (
    .clk( recv_adp__clk[4] ),
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 routers__recv__msg [0:4][0:2];
  logic [0:0] routers__recv__yum [0:4][0:2][0:1];
  logic [0:0] routers__send__en [0:4][0:2];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 routers__send__msg [0:4][0:2];
  logic [0:0] routers__send__yum [0:4][0:2][0:1];

  RingRouterRTL__026f281edb6eacb0 routers__0
  (
    .clk( routers__clk[0] ),
    .pos( routers__pos[0] ),
  ...
  RingRouterRTL__026f281edb6eacb0 routers__1
  (
    .clk( routers__clk[1] ),
    .pos( routers__pos[1] ),
  ...
  RingRouterRTL__026f281edb6eacb0 routers__2
  (
    .clk( routers__clk[2] ),
    .pos( routers__pos[2] ),
  ...
  RingRouterRTL__026f281edb6eacb0 routers__3
  (
    .clk( routers__clk[3] ),
    .pos( routers__pos[3] ),
  ...
  RingRouterRTL__026f281edb6eacb0 routers__4
  (
    .clk( routers__clk[4] ),
    .pos( routers__pos[4] ),
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_adp__recv__msg [0:4];
  logic [0:0] send_adp__recv__yum [0:4][0:1];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_adp__send__msg [0:4];
  logic [0:0] send_adp__send__rdy [0:4];
  logic [0:0] send_adp__send__val [0:4];

  CreditRecvRTL2SendRTL__595340bae1c07585 send_adp__0
  (
    .clk( send_adp__clk[0] ),
  ...
  CreditRecvRTL2SendRTL__595340bae1c07585 send_adp__1
  (
    .clk( send_adp__clk[1] ),
  ...
  CreditRecvRTL2SendRTL__595340bae1c07585 send_adp__2
  (
    .clk( send_adp__clk[2] ),
  ...
  CreditRecvRTL2SendRTL__595340bae1c07585 send_adp__3
  (
    .clk( send_adp__clk[3] ),
  ...
  CreditRecvRTL2SendRTL__595340bae1c07585 send_adp__4
  (
    .clk( send_adp__clk[4] ),
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_TileSramXbarPacket_4_3_128__1370121529e22979__ninputs_2
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__df706a7ead599203
(
  input  logic [0:0] clk ,
  input  TileSramXbarPacket_4_3_128__1370121529e22979 in_ [0:1],
  output TileSramXbarPacket_4_3_128__1370121529e22979 out ,
  input  logic [0:0] reset ,
  input  logic [0:0] sel 
);
...
// PyMTL Component RegisterFile Definition
// Full name: RegisterFile__Type_TileSramXbarPacket_4_3_128__1370121529e22979__nregs_2__rd_ports_1__wr_ports_1__const_zero_False
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/register_files.py

module RegisterFile__6b3fc2579bad867b
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output TileSramXbarPacket_4_3_128__1370121529e22979 rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  TileSramXbarPacket_4_3_128__1370121529e22979 wdata [0:0],
  input  logic [0:0] wen [0:0]
);
  localparam logic [0:0] __const__rd_ports_at_up_rf_read  = 1'd1;
  localparam logic [0:0] __const__wr_ports_at_up_rf_write  = 1'd1;
  TileSramXbarPacket_4_3_128__1370121529e22979 regs [0:1];
...
// PyMTL Component BypassQueueDpathRTL Definition
// Full name: BypassQueueDpathRTL__EntryType_TileSramXbarPacket_4_3_128__1370121529e22979__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueDpathRTL__ea905286327daf21
(
  input  logic [0:0] clk ,
  input  logic [0:0] mux_sel ,
  input  logic [0:0] raddr ,
  input  TileSramXbarPacket_4_3_128__1370121529e22979 recv_msg ,
  input  logic [0:0] reset ,
  output TileSramXbarPacket_4_3_128__1370121529e22979 send_msg ,
  input  logic [0:0] waddr ,
  input  logic [0:0] wen 
);
  //-------------------------------------------------------------
  ...
  logic [0:0] mux__clk;
  TileSramXbarPacket_4_3_128__1370121529e22979 mux__in_ [0:1];
  TileSramXbarPacket_4_3_128__1370121529e22979 mux__out;
  logic [0:0] mux__reset;
  logic [0:0] mux__sel;

  Mux__df706a7ead599203 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
  ...
  logic [0:0] rf__clk;
  logic [0:0] rf__raddr [0:0];
  TileSramXbarPacket_4_3_128__1370121529e22979 rf__rdata [0:0];
  logic [0:0] rf__reset;
  logic [0:0] rf__waddr [0:0];
  TileSramXbarPacket_4_3_128__1370121529e22979 rf__wdata [0:0];
  logic [0:0] rf__wen [0:0];

  RegisterFile__6b3fc2579bad867b rf
  (
    .clk( rf__clk ),
    .raddr( rf__raddr ),
    .rdata( rf__rdata ),
...
// PyMTL Component BypassQueueRTL Definition
// Full name: BypassQueueRTL__EntryType_TileSramXbarPacket_4_3_128__1370121529e22979__num_entries_2
// At /home/jovank/STEP-VectorCGRA/lib/basic/val_rdy/queues.py

module BypassQueueRTL__ea905286327daf21
(
  input  logic [0:0] clk ,
  output logic [1:0] count ,
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output TileSramXbarPacket_4_3_128__1370121529e22979 send__msg  ,
  input logic [0:0] send__rdy  ,
  output logic [0:0] send__val  
);
  //-------------------------------------------------------------
  ...
  logic [0:0] dpath__mux_sel;
  logic [0:0] dpath__raddr;
  TileSramXbarPacket_4_3_128__1370121529e22979 dpath__recv_msg;
  logic [0:0] dpath__reset;
  TileSramXbarPacket_4_3_128__1370121529e22979 dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__ea905286327daf21 dpath
  (
    .clk( dpath__clk ),
    .mux_sel( dpath__mux_sel ),
    .raddr( dpath__raddr ),
...
// PyMTL Component InputUnitRTL Definition
// Full name: InputUnitRTL__PacketType_TileSramXbarPacket_4_3_128__1370121529e22979__QueueType_BypassQueueRTL
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/InputUnitRTL.py

module InputUnitRTL__616a5a4428083b18
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg  ,
  ...
  logic [1:0] queue__count;
  logic [0:0] queue__reset;
  TileSramXbarPacket_4_3_128__1370121529e22979 queue__recv__msg;
  logic [0:0] queue__recv__rdy;
  logic [0:0] queue__recv__val;
  TileSramXbarPacket_4_3_128__1370121529e22979 queue__send__msg;
  logic [0:0] queue__send__rdy;
  logic [0:0] queue__send__val;

  BypassQueueRTL__ea905286327daf21 queue
  (
    .clk( queue__clk ),
    .count( queue__count ),
    .reset( queue__reset ),
...
// PyMTL Component OutputUnitRTL Definition
// Full name: OutputUnitRTL__PacketType_TileSramXbarPacket_4_3_128__1370121529e22979__QueueType_None
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/OutputUnitRTL.py

module OutputUnitRTL__fcbe493e8e107114
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg  ,
...
// PyMTL Component XbarRouteUnitRTL Definition
// Full name: XbarRouteUnitRTL__PacketType_TileSramXbarPacket_4_3_128__1370121529e22979__num_outports_3
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/xbar/XbarRouteUnitRTL.py

module XbarRouteUnitRTL__900c4f162d3ec626
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output TileSramXbarPacket_4_3_128__1370121529e22979 send__msg [0:2] ,
  input logic [0:0] send__rdy [0:2] ,
  output logic [0:0] send__val [0:2] 
);
...
// PyMTL Component Mux Definition
// Full name: Mux__Type_TileSramXbarPacket_4_3_128__1370121529e22979__ninputs_4
// At /home/jovank/env/lib/python3.10/site-packages/pymtl3/stdlib/primitive/arithmetics.py

module Mux__95fa59b8411b6cd1
(
  input  logic [0:0] clk ,
  input  TileSramXbarPacket_4_3_128__1370121529e22979 in_ [0:3],
  output TileSramXbarPacket_4_3_128__1370121529e22979 out ,
  input  logic [0:0] reset ,
  input  logic [1:0] sel 
);
...
// PyMTL Component SwitchUnitRTL Definition
// Full name: SwitchUnitRTL__PacketType_TileSramXbarPacket_4_3_128__1370121529e22979__num_inports_4
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/router/SwitchUnitRTL.py

module SwitchUnitRTL__9252b4dd12ffe233
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg [0:3] ,
  ...
  logic [0:0] mux__clk;
  TileSramXbarPacket_4_3_128__1370121529e22979 mux__in_ [0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 mux__out;
  logic [0:0] mux__reset;
  logic [1:0] mux__sel;

  Mux__95fa59b8411b6cd1 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
...
// PyMTL Component XbarBypassQueueRTL Definition
// Full name: XbarBypassQueueRTL__PacketType_TileSramXbarPacket_4_3_128__1370121529e22979__num_inports_4__num_outports_3__InputUnitType_InputUnitRTL__RouteUnitType_XbarRouteUnitRTL__SwitchUnitType_SwitchUnitRTL__OutputUnitType_OutputUnitRTL
// At /home/jovank/STEP-VectorCGRA/noc/PyOCN/pymtl3_net/xbar/XbarBypassQueueRTL.py

module XbarBypassQueueRTL__3966b74635af5b63
(
  input  logic [0:0] clk ,
  output TileSramXbarPacket_4_3_128__1370121529e22979 packet_on_input_units [0:3],
  input  logic [0:0] reset ,
  input TileSramXbarPacket_4_3_128__1370121529e22979 recv__msg [0:3] ,
  output logic [0:0] recv__rdy [0:3] ,
  input logic [0:0] recv__val [0:3] ,
  ...
  TileSramXbarPacket_4_3_128__1370121529e22979 input_units__recv__msg [0:3];
  logic [0:0] input_units__recv__rdy [0:3];
  logic [0:0] input_units__recv__val [0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 input_units__send__msg [0:3];
  logic [0:0] input_units__send__rdy [0:3];
  logic [0:0] input_units__send__val [0:3];

  InputUnitRTL__616a5a4428083b18 input_units__0
  (
    .clk( input_units__clk[0] ),
    .reset( input_units__reset[0] ),
    .recv__msg( input_units__recv__msg[0] ),
  ...
  InputUnitRTL__616a5a4428083b18 input_units__1
  (
    .clk( input_units__clk[1] ),
    .reset( input_units__reset[1] ),
    .recv__msg( input_units__recv__msg[1] ),
  ...
  InputUnitRTL__616a5a4428083b18 input_units__2
  (
    .clk( input_units__clk[2] ),
    .reset( input_units__reset[2] ),
    .recv__msg( input_units__recv__msg[2] ),
  ...
  InputUnitRTL__616a5a4428083b18 input_units__3
  (
    .clk( input_units__clk[3] ),
    .reset( input_units__reset[3] ),
    .recv__msg( input_units__recv__msg[3] ),
  ...
  logic [0:0] output_units__clk [0:2];
  logic [0:0] output_units__reset [0:2];
  TileSramXbarPacket_4_3_128__1370121529e22979 output_units__recv__msg [0:2];
  logic [0:0] output_units__recv__rdy [0:2];
  logic [0:0] output_units__recv__val [0:2];
  TileSramXbarPacket_4_3_128__1370121529e22979 output_units__send__msg [0:2];
  logic [0:0] output_units__send__rdy [0:2];
  logic [0:0] output_units__send__val [0:2];

  OutputUnitRTL__fcbe493e8e107114 output_units__0
  (
    .clk( output_units__clk[0] ),
    .reset( output_units__reset[0] ),
    .recv__msg( output_units__recv__msg[0] ),
  ...
  OutputUnitRTL__fcbe493e8e107114 output_units__1
  (
    .clk( output_units__clk[1] ),
    .reset( output_units__reset[1] ),
    .recv__msg( output_units__recv__msg[1] ),
  ...
  OutputUnitRTL__fcbe493e8e107114 output_units__2
  (
    .clk( output_units__clk[2] ),
    .reset( output_units__reset[2] ),
    .recv__msg( output_units__recv__msg[2] ),
  ...
  TileSramXbarPacket_4_3_128__1370121529e22979 route_units__recv__msg [0:3];
  logic [0:0] route_units__recv__rdy [0:3];
  logic [0:0] route_units__recv__val [0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 route_units__send__msg [0:3][0:2];
  logic [0:0] route_units__send__rdy [0:3][0:2];
  logic [0:0] route_units__send__val [0:3][0:2];

  XbarRouteUnitRTL__900c4f162d3ec626 route_units__0
  (
    .clk( route_units__clk[0] ),
    .reset( route_units__reset[0] ),
    .recv__msg( route_units__recv__msg[0] ),
  ...
  XbarRouteUnitRTL__900c4f162d3ec626 route_units__1
  (
    .clk( route_units__clk[1] ),
    .reset( route_units__reset[1] ),
    .recv__msg( route_units__recv__msg[1] ),
  ...
  XbarRouteUnitRTL__900c4f162d3ec626 route_units__2
  (
    .clk( route_units__clk[2] ),
    .reset( route_units__reset[2] ),
    .recv__msg( route_units__recv__msg[2] ),
  ...
  XbarRouteUnitRTL__900c4f162d3ec626 route_units__3
  (
    .clk( route_units__clk[3] ),
    .reset( route_units__reset[3] ),
    .recv__msg( route_units__recv__msg[3] ),
  ...
  logic [0:0] switch_units__clk [0:2];
  logic [0:0] switch_units__reset [0:2];
  TileSramXbarPacket_4_3_128__1370121529e22979 switch_units__recv__msg [0:2][0:3];
  logic [0:0] switch_units__recv__rdy [0:2][0:3];
  logic [0:0] switch_units__recv__val [0:2][0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 switch_units__send__msg [0:2];
  logic [0:0] switch_units__send__rdy [0:2];
  logic [0:0] switch_units__send__val [0:2];

  SwitchUnitRTL__9252b4dd12ffe233 switch_units__0
  (
    .clk( switch_units__clk[0] ),
    .reset( switch_units__reset[0] ),
    .recv__msg( switch_units__recv__msg[0] ),
  ...
  SwitchUnitRTL__9252b4dd12ffe233 switch_units__1
  (
    .clk( switch_units__clk[1] ),
    .reset( switch_units__reset[1] ),
    .recv__msg( switch_units__recv__msg[1] ),
  ...
  SwitchUnitRTL__9252b4dd12ffe233 switch_units__2
  (
    .clk( switch_units__clk[2] ),
    .reset( switch_units__reset[2] ),
    .recv__msg( switch_units__recv__msg[2] ),
...
// Full name: DataMemWithCrossbarRTL__NocPktType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__CgraPayloadType_MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__data_mem_size_global_128__data_mem_size_per_bank_16__num_banks_per_cgra_2__num_rd_tiles_3__num_wr_tiles_3__multi_cgra_rows_1__multi_cgra_columns_4__num_tiles_4__idTo2d_map_{0: [0, 0], 1: [1, 0], 2: [2, 0], 3: [3, 0]}__preload_data_per_bank_None
// At /home/jovank/STEP-VectorCGRA/mem/data/DataMemWithCrossbarRTL.py

module DataMemWithCrossbarRTL__266f45ac01e87489
(
  ...
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_noc_load_request__msg  ,
  output logic [0:0] recv_from_noc_load_request__rdy  ,
  input logic [0:0] recv_from_noc_load_request__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_noc_load_response_pkt__msg  ,
  output logic [0:0] recv_from_noc_load_response_pkt__rdy  ,
  input logic [0:0] recv_from_noc_load_response_pkt__val  ,
  input InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d recv_from_noc_store_request__msg  ,
  ...
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_noc_load_request_pkt__msg  ,
  input logic [0:0] send_to_noc_load_request_pkt__rdy  ,
  output logic [0:0] send_to_noc_load_request_pkt__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_noc_load_response_pkt__msg  ,
  input logic [0:0] send_to_noc_load_response_pkt__rdy  ,
  output logic [0:0] send_to_noc_load_response_pkt__val  ,
  output InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d send_to_noc_store_pkt__msg  ,
  ...
  TileSramXbarPacket_4_3_128__1370121529e22979 rd_pkt [0:3];
  logic [0:0] send_to_noc_load_pending;
  TileSramXbarPacket_4_3_128__1370121529e22979 wr_pkt [0:3];
  //-------------------------------------------------------------
  // Component read_crossbar
  //-------------------------------------------------------------

  logic [0:0] read_crossbar__clk;
  TileSramXbarPacket_4_3_128__1370121529e22979 read_crossbar__packet_on_input_units [0:3];
  logic [0:0] read_crossbar__reset;
  TileSramXbarPacket_4_3_128__1370121529e22979 read_crossbar__recv__msg [0:3];
  logic [0:0] read_crossbar__recv__rdy [0:3];
  logic [0:0] read_crossbar__recv__val [0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 read_crossbar__send__msg [0:2];
  logic [0:0] read_crossbar__send__rdy [0:2];
  logic [0:0] read_crossbar__send__val [0:2];

  XbarBypassQueueRTL__3966b74635af5b63 read_crossbar
  (
  ...
  TileSramXbarPacket_4_3_128__1370121529e22979 write_crossbar__packet_on_input_units [0:3];
  logic [0:0] write_crossbar__reset;
  TileSramXbarPacket_4_3_128__1370121529e22979 write_crossbar__recv__msg [0:3];
  logic [0:0] write_crossbar__recv__rdy [0:3];
  logic [0:0] write_crossbar__recv__val [0:3];
  TileSramXbarPacket_4_3_128__1370121529e22979 write_crossbar__send__msg [0:2];
  logic [0:0] write_crossbar__send__rdy [0:2];
  logic [0:0] write_crossbar__send__val [0:2];

  XbarBypassQueueRTL__3966b74635af5b63 write_crossbar
  (
  ...
  always_comb begin : assemble_xbar_pkt
    ...
    if ( init_mem_done != 1'd0 ) begin
      ...
      for ( int unsigned i = 1'd0; i < 2'( __const__num_wr_tiles_at_assemble_xbar_pkt ); i += 1'd1 ) begin
        ...
        wr_pkt[2'(i)] = { 2'(i), __tmpvar__assemble_xbar_pkt_bank_index_store_local, __tmpvar__assemble_xbar_pkt_recv_waddr, 2'd0, 3'd0 };
      end
      ...
      wr_pkt[2'( __const__num_wr_tiles_at_assemble_xbar_pkt )] = { 2'( __const__num_wr_tiles_at_assemble_xbar_pkt ), __tmpvar__assemble_xbar_pkt_bank_index_store_from_noc, __tmpvar__assemble_xbar_pkt_recv_waddr_from_noc, 2'd0, 3'd0 };
    end
  end
  ...
  always_comb begin : update_all
    ...
    send_to_noc_load_response_pkt__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, { 4'd0, 35'd0, 7'd0, 103'd0, 4'd0 } };
    for ( int unsigned i = 1'd0; i < 2'( __const__num_wr_tiles_at_update_all ); i += 1'd1 ) begin
    ...
    send_to_noc_store_pkt__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, { 4'd0, 35'd0, 7'd0, 103'd0, 4'd0 } };
    ...
    for ( int unsigned i = 1'd0; i < 3'( __const__num_xbar_in_rd_ports_at_update_all ); i += 1'd1 ) begin
      ...
      read_crossbar__recv__msg[2'(i)] = { 2'd0, 2'd0, 7'd0, 2'd0, 3'd0 };
    end
    ...
    for ( int unsigned i = 1'd0; i < 3'( __const__num_xbar_in_wr_ports_at_update_all ); i += 1'd1 ) begin
      ...
      write_crossbar__recv__msg[2'(i)] = { 2'd0, 2'd0, 7'd0, 2'd0, 3'd0 };
    end
    ...
    send_to_noc_load_request_pkt__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, { 4'd0, 35'd0, 7'd0, 103'd0, 4'd0 } };
    ...
    if ( init_mem_done == 1'd0 ) begin
      ...
      send_to_noc_load_request_pkt__msg = { cgra_id, 2'd0, idTo2d_x_lut[cgra_id], idTo2d_y_lut[cgra_id], 2'd0, 1'd0, 3'd0, 3'd0, 8'd0, 2'd0, { 4'( __const__CMD_LOAD_REQUEST ), 35'd0, read_crossbar__send__msg[2'( __const__num_banks_per_cgra_at_update_all )].addr, 103'd0, 4'd0 } };
...
// Full name: CtrlMemDynamicRTL__IntraCgraPktType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__CgraPayloadType_MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05__CtrlType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__ctrl_mem_size_10__num_fu_inports_4__num_fu_outports_2__num_tile_inports_4__num_tile_outports_4__num_cgras_4__num_tiles_4__ctrl_count_per_iter_2__total_ctrl_steps_2
// At /home/jovank/STEP-VectorCGRA/mem/ctrl/CtrlMemDynamicRTL.py

module CtrlMemDynamicRTL__187963390ea6e66f
(
  input  logic [1:0] cgra_id ,
  input  logic [0:0] clk ,
  ...
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_pkt_from_controller__msg  ,
  ...
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_pkt_to_controller__msg  ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_pkt_queue__recv__msg;
  logic [0:0] recv_pkt_queue__recv__rdy;
  logic [0:0] recv_pkt_queue__recv__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_pkt_queue__send__msg;
  logic [0:0] recv_pkt_queue__send__rdy;
  logic [0:0] recv_pkt_queue__send__val;

  NormalQueueRTL__42e19db10df79104 recv_pkt_queue
  (
  ...
  always_comb begin : update_send_out_signal
    ...
    send_pkt_to_controller__msg = { 3'd0, 3'( __const__num_tiles_at_update_send_out_signal ), 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, { 4'( __const__CMD_COMPLETE ), 35'd0, 7'd0, 103'd0, 4'd0 } };
    if ( start_iterate_ctrl == 1'd1 ) begin
      if ( ( ( total_ctrl_steps_val > 11'd0 ) & ( times == total_ctrl_steps_val ) ) | ( reg_file__rdata[1'd0].operation == 6'( __const__OPT_START ) ) ) begin
        ...
        if ( ( ( ( ~sent_complete ) & ( total_ctrl_steps_val > 11'd0 ) ) & ( times == total_ctrl_steps_val ) ) & start_iterate_ctrl ) begin
          send_pkt_to_controller__msg = { tile_id, 3'( __const__num_tiles_at_update_send_out_signal ), 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, { 4'( __const__CMD_COMPLETE ), 35'd0, 7'd0, 103'd0, 4'd0 } };
...
// Full name: CrossbarRTL__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__PredicateType_CGRAData_1_1__payload_1__predicate_1__CtrlType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__num_inports_2__num_outports_8__num_tiles_4
// At /home/jovank/STEP-VectorCGRA/noc/CrossbarRTL.py

module CrossbarRTL__4d774e58705ead8d
(
  input  logic [0:0] clk ,
...
// PyMTL Component CrossbarRTL Definition
// Full name: CrossbarRTL__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__PredicateType_CGRAData_1_1__payload_1__predicate_1__CtrlType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__num_inports_4__num_outports_8__num_tiles_4
// At /home/jovank/STEP-VectorCGRA/noc/CrossbarRTL.py

module CrossbarRTL__1585e47868e1aeb1
(
  input  logic [0:0] clk ,
  input  logic [0:0] compute_done ,
  input  logic [0:0] crossbar_id ,
...
// Full name: TileRTL__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__PredicateType_CGRAData_1_1__payload_1__predicate_1__CtrlPktType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__CgraPayloadType_MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05__CtrlSignalType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__ctrl_mem_size_10__data_mem_size_128__num_ctrl_2__total_steps_2__num_fu_inports_4__num_fu_outports_2__num_tile_inports_4__num_tile_outports_4__num_cgras_4__num_tiles_4__num_registers_per_reg_bank_8__Fu_FlexibleFuRTL__FuList_[<class 'fu.single.AdderRTL.AdderRTL'>, <class 'fu.single.MulRTL.MulRTL'>, <class 'fu.single.LogicRTL.LogicRTL'>, <class 'fu.single.ShifterRTL.ShifterRTL'>, <class 'fu.single.PhiRTL.PhiRTL'>, <class 'fu.single.CompRTL.CompRTL'>, <class 'fu.single.BranchRTL.BranchRTL'>, <class 'fu.single.MemUnitRTL.MemUnitRTL'>, <class 'fu.single.SelRTL.SelRTL'>, <class 'fu.single.RetRTL.RetRTL'>, <class 'fu.single.NahRTL.NahRTL'>]
// At /home/jovank/STEP-VectorCGRA/tile/TileRTL.py

module TileRTL__bc0bdf6ba72b5c47
(
  input  logic [1:0] cgra_id ,
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  output logic [0:0] recv_data__rdy [0:3] ,
  input logic [0:0] recv_data__val [0:3] ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 recv_from_controller_pkt__msg  ,
  ...
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 send_to_controller_pkt__msg  ,
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 ctrl_mem__recv_pkt_from_controller__msg;
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 ctrl_mem__send_pkt_to_controller__msg;
  logic [0:0] ctrl_mem__send_pkt_to_controller__rdy;
  logic [0:0] ctrl_mem__send_pkt_to_controller__val;

  CtrlMemDynamicRTL__187963390ea6e66f ctrl_mem
  (
  ...
  FlexibleFuRTL__3fdc9b15dc597cc8 element
  (
    .clk( element__clk ),
  ...
  CrossbarRTL__4d774e58705ead8d fu_crossbar
  (
  ...
  CrossbarRTL__1585e47868e1aeb1 routing_crossbar
  (
  ...
  always_comb begin : feed_pkt
    ctrl_mem__recv_pkt_from_controller__msg = { 3'd0, 3'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 153'd0 };
  ...
  always_comb begin : update_send_out_signal
    ...
    send_to_controller_pkt__msg = { 3'd0, 3'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 153'd0 };
...
// Full name: TileWrapperRTL__CgraIdType_Bits2__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__PredicateType_CGRAData_1_1__payload_1__predicate_1__CtrlPktType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__CgraPayloadType_MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05__CtrlSignalType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__ctrl_mem_size_10__data_mem_size_global_128__num_ctrl_2__total_steps_2__num_fu_inports_4__num_fu_outports_2__num_tile_inports_4__num_tile_outports_4__num_cgras_4__num_tiles_4__num_registers_per_reg_bank_8__width_2__height_2__cgra_topology_Mesh__Fu_FlexibleFuRTL__FuList_[<class 'fu.single.AdderRTL.AdderRTL'>, <class 'fu.single.MulRTL.MulRTL'>, <class 'fu.single.LogicRTL.LogicRTL'>, <class 'fu.single.ShifterRTL.ShifterRTL'>, <class 'fu.single.PhiRTL.PhiRTL'>, <class 'fu.single.CompRTL.CompRTL'>, <class 'fu.single.BranchRTL.BranchRTL'>, <class 'fu.single.MemUnitRTL.MemUnitRTL'>, <class 'fu.single.SelRTL.SelRTL'>, <class 'fu.single.RetRTL.RetRTL'>, <class 'fu.single.NahRTL.NahRTL'>]
// At /home/jovank/STEP-VectorCGRA/tile/TileWrapperRTL.py

module TileWrapperRTL__bbdeb51e8d985d7e
(
  input  logic [1:0] cgra_id ,
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  input CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tile_from_mem_rdata__msg [0:2] ,
  output logic [0:0] tile_from_mem_rdata__rdy [0:2] ,
  input logic [0:0] tile_from_mem_rdata__val [0:2] ,
  input IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tile_recv_from_controller_pkt__msg [0:3] ,
  output logic [0:0] tile_recv_from_controller_pkt__rdy [0:3] ,
  input logic [0:0] tile_recv_from_controller_pkt__val [0:3] ,
  output IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tile_send_to_controller_pkt__msg [0:3] ,
  input logic [0:0] tile_send_to_controller_pkt__rdy [0:3] ,
  output logic [0:0] tile_send_to_controller_pkt__val [0:3] ,
  output logic [6:0] tile_to_mem_raddr__msg [0:2] ,
  input logic [0:0] tile_to_mem_raddr__rdy [0:2] ,
  output logic [0:0] tile_to_mem_raddr__val [0:2] ,
  output logic [6:0] tile_to_mem_waddr__msg [0:2] ,
  input logic [0:0] tile_to_mem_waddr__rdy [0:2] ,
  output logic [0:0] tile_to_mem_waddr__val [0:2] ,
  output CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tile_to_mem_wdata__msg [0:2] ,
  input logic [0:0] tile_to_mem_wdata__rdy [0:2] ,
  output logic [0:0] tile_to_mem_wdata__val [0:2] 
);
  //-------------------------------------------------------------
  // Component tile[0:3]
  //-------------------------------------------------------------
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tile__recv_from_controller_pkt__msg [0:3];
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tile__send_to_controller_pkt__msg [0:3];
  ...
  TileRTL__bc0bdf6ba72b5c47 tile__0
  (
  ...
  TileRTL__bc0bdf6ba72b5c47 tile__1
  (
  ...
  TileRTL__bc0bdf6ba72b5c47 tile__2
  (
  ...
  TileRTL__bc0bdf6ba72b5c47 tile__3
  (
...
// Full name: CgraRTL__DataType_CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1__PredicateType_CGRAData_1_1__payload_1__predicate_1__CtrlPktType_IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902__CgraPayloadType_MultiCgraPayload_Cmd_Data_DataAddr_Ctrl_CtrlAddr__62cedfe49eeddc05__CtrlSignalType_CGRAConfig_6_4_2_4_4_1_3__d91e50bf562f5389__NocPktType_InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d__CgraIdType_Bits2__multi_cgra_rows_1__multi_cgra_columns_4__width_2__height_2__ctrl_mem_size_10__data_mem_size_global_128__data_mem_size_per_bank_16__num_banks_per_cgra_2__num_registers_per_reg_bank_8__num_ctrl_2__total_steps_2__FunctionUnit_FlexibleFuRTL__FuList_[<class 'fu.single.AdderRTL.AdderRTL'>, <class 'fu.single.MulRTL.MulRTL'>, <class 'fu.single.LogicRTL.LogicRTL'>, <class 'fu.single.ShifterRTL.ShifterRTL'>, <class 'fu.single.PhiRTL.PhiRTL'>, <class 'fu.single.CompRTL.CompRTL'>, <class 'fu.single.BranchRTL.BranchRTL'>, <class 'fu.single.MemUnitRTL.MemUnitRTL'>, <class 'fu.single.SelRTL.SelRTL'>, <class 'fu.single.RetRTL.RetRTL'>, <class 'fu.single.NahRTL.NahRTL'>]__cgra_topology_Mesh__controller2addr_map_{0: [0, 31], 1: [32, 63], 2: [64, 95], 3: [96, 127]}__idTo2d_map_{0: [0, 0], 1: [1, 0], 2: [2, 0], 3: [3, 0]}__preload_data_None__is_multi_cgra_False
// At /home/jovank/STEP-VectorCGRA/cgra/CgraRTL.py

module CgraRTL__999b32a09cf5f2fc
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  localparam logic [1:0] __const__tile_count_sub_at_comb_logic  = 2'd3;
  localparam logic [1:0] __const__tile_count_sub_at_counter_logic  = 2'd3;
  localparam logic [1:0] __const__width_at_tie_off_boundary_recv_msgs  = 2'd2;
  localparam logic [1:0] __const__height_at_tie_off_boundary_recv_msgs  = 2'd2;
  logic [1:0] cmd_e_count;
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d bypass_queue__recv__msg;
  logic [0:0] bypass_queue__recv__rdy;
  logic [0:0] bypass_queue__recv__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d bypass_queue__send__msg;
  logic [0:0] bypass_queue__send__rdy;
  logic [0:0] bypass_queue__send__val;

  BypassQueueRTL__5c8459ccf9891016 bypass_queue
  (
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 controller__recv_from_cpu_pkt__msg;
  logic [0:0] controller__recv_from_cpu_pkt__rdy;
  logic [0:0] controller__recv_from_cpu_pkt__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 controller__recv_from_ctrl_ring_pkt__msg;
  logic [0:0] controller__recv_from_ctrl_ring_pkt__rdy;
  logic [0:0] controller__recv_from_ctrl_ring_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__recv_from_inter_cgra_noc__msg;
  logic [0:0] controller__recv_from_inter_cgra_noc__rdy;
  logic [0:0] controller__recv_from_inter_cgra_noc__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__recv_from_tile_load_request_pkt__msg;
  logic [0:0] controller__recv_from_tile_load_request_pkt__rdy;
  logic [0:0] controller__recv_from_tile_load_request_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__recv_from_tile_load_response_pkt__msg;
  logic [0:0] controller__recv_from_tile_load_response_pkt__rdy;
  logic [0:0] controller__recv_from_tile_load_response_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__recv_from_tile_store_request_pkt__msg;
  logic [0:0] controller__recv_from_tile_store_request_pkt__rdy;
  logic [0:0] controller__recv_from_tile_store_request_pkt__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 controller__send_to_cpu_pkt__msg;
  logic [0:0] controller__send_to_cpu_pkt__rdy;
  logic [0:0] controller__send_to_cpu_pkt__val;
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 controller__send_to_ctrl_ring_pkt__msg;
  logic [0:0] controller__send_to_ctrl_ring_pkt__rdy;
  logic [0:0] controller__send_to_ctrl_ring_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__send_to_inter_cgra_noc__msg;
  logic [0:0] controller__send_to_inter_cgra_noc__rdy;
  logic [0:0] controller__send_to_inter_cgra_noc__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__send_to_mem_load_request__msg;
  logic [0:0] controller__send_to_mem_load_request__rdy;
  logic [0:0] controller__send_to_mem_load_request__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__send_to_mem_store_request__msg;
  logic [0:0] controller__send_to_mem_store_request__rdy;
  logic [0:0] controller__send_to_mem_store_request__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d controller__send_to_tile_load_response__msg;
  logic [0:0] controller__send_to_tile_load_response__rdy;
  logic [0:0] controller__send_to_tile_load_response__val;

  ControllerRTL__cb7ec46bb4dde248 controller
  (
  ...
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 ctrl_ring__recv__msg [0:4];
  logic [0:0] ctrl_ring__recv__rdy [0:4];
  logic [0:0] ctrl_ring__recv__val [0:4];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 ctrl_ring__send__msg [0:4];
  logic [0:0] ctrl_ring__send__rdy [0:4];
  logic [0:0] ctrl_ring__send__val [0:4];

  RingNetworkRTL__40fc70d68ad976a2 ctrl_ring
  (
    .clk( ctrl_ring__clk ),
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__recv_from_noc_load_request__msg;
  logic [0:0] data_mem__recv_from_noc_load_request__rdy;
  logic [0:0] data_mem__recv_from_noc_load_request__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__recv_from_noc_load_response_pkt__msg;
  logic [0:0] data_mem__recv_from_noc_load_response_pkt__rdy;
  logic [0:0] data_mem__recv_from_noc_load_response_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__recv_from_noc_store_request__msg;
  ...
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__send_to_noc_load_request_pkt__msg;
  logic [0:0] data_mem__send_to_noc_load_request_pkt__rdy;
  logic [0:0] data_mem__send_to_noc_load_request_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__send_to_noc_load_response_pkt__msg;
  logic [0:0] data_mem__send_to_noc_load_response_pkt__rdy;
  logic [0:0] data_mem__send_to_noc_load_response_pkt__val;
  InterCgraPacket_4_4x1_4_8_4_CgraPayload__0fc799b11973405d data_mem__send_to_noc_store_pkt__msg;
  logic [0:0] data_mem__send_to_noc_store_pkt__rdy;
  logic [0:0] data_mem__send_to_noc_store_pkt__val;

  DataMemWithCrossbarRTL__266f45ac01e87489 data_mem
  (
  ...
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__recv_data_on_boundary_east__msg [0:1];
  logic [0:0] tiles__recv_data_on_boundary_east__rdy [0:1];
  logic [0:0] tiles__recv_data_on_boundary_east__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__recv_data_on_boundary_north__msg [0:1];
  logic [0:0] tiles__recv_data_on_boundary_north__rdy [0:1];
  logic [0:0] tiles__recv_data_on_boundary_north__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__recv_data_on_boundary_south__msg [0:1];
  logic [0:0] tiles__recv_data_on_boundary_south__rdy [0:1];
  logic [0:0] tiles__recv_data_on_boundary_south__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__recv_data_on_boundary_west__msg [0:1];
  logic [0:0] tiles__recv_data_on_boundary_west__rdy [0:1];
  logic [0:0] tiles__recv_data_on_boundary_west__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__send_data_on_boundary_east__msg [0:1];
  logic [0:0] tiles__send_data_on_boundary_east__rdy [0:1];
  logic [0:0] tiles__send_data_on_boundary_east__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__send_data_on_boundary_north__msg [0:1];
  logic [0:0] tiles__send_data_on_boundary_north__rdy [0:1];
  logic [0:0] tiles__send_data_on_boundary_north__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__send_data_on_boundary_south__msg [0:1];
  logic [0:0] tiles__send_data_on_boundary_south__rdy [0:1];
  logic [0:0] tiles__send_data_on_boundary_south__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__send_data_on_boundary_west__msg [0:1];
  logic [0:0] tiles__send_data_on_boundary_west__rdy [0:1];
  logic [0:0] tiles__send_data_on_boundary_west__val [0:1];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__tile_from_mem_rdata__msg [0:2];
  logic [0:0] tiles__tile_from_mem_rdata__rdy [0:2];
  logic [0:0] tiles__tile_from_mem_rdata__val [0:2];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tiles__tile_recv_from_controller_pkt__msg [0:3];
  logic [0:0] tiles__tile_recv_from_controller_pkt__rdy [0:3];
  logic [0:0] tiles__tile_recv_from_controller_pkt__val [0:3];
  IntraCgraPacket_4_4x1_4_8_2_CgraPayload__0691829c67984902 tiles__tile_send_to_controller_pkt__msg [0:3];
  logic [0:0] tiles__tile_send_to_controller_pkt__rdy [0:3];
  logic [0:0] tiles__tile_send_to_controller_pkt__val [0:3];
  logic [6:0] tiles__tile_to_mem_raddr__msg [0:2];
  logic [0:0] tiles__tile_to_mem_raddr__rdy [0:2];
  logic [0:0] tiles__tile_to_mem_raddr__val [0:2];
  logic [6:0] tiles__tile_to_mem_waddr__msg [0:2];
  logic [0:0] tiles__tile_to_mem_waddr__rdy [0:2];
  logic [0:0] tiles__tile_to_mem_waddr__val [0:2];
  CgraData_32_1_1_1__payload_32__predicate_1__bypass_1__delay_1 tiles__tile_to_mem_wdata__msg [0:2];
  logic [0:0] tiles__tile_to_mem_wdata__rdy [0:2];
  logic [0:0] tiles__tile_to_mem_wdata__val [0:2];

  TileWrapperRTL__bbdeb51e8d985d7e tiles
  (
  ...
  always_comb begin : comb_logic
    ...
    send_to_cpu_pkt__last = cmd_e_valid & ( cmd_e_count == 2'( __const__tile_count_sub_at_comb_logic ) );
  end
  ...
  always_comb begin : tie_off_boundary_recv_msgs
    for ( int unsigned tile_col = 1'd0; tile_col < 2'( __const__width_at_tie_off_boundary_recv_msgs ); tile_col += 1'd1 ) begin
      tiles__recv_data_on_boundary_north__msg[1'(tile_col)] = { 32'd0, 1'd0, 1'd0, 1'd0 };
      tiles__recv_data_on_boundary_south__msg[1'(tile_col)] = { 32'd0, 1'd0, 1'd0, 1'd0 };
    end
    for ( int unsigned tile_row = 1'd0; tile_row < 2'( __const__height_at_tie_off_boundary_recv_msgs ); tile_row += 1'd1 ) begin
      tiles__recv_data_on_boundary_west__msg[1'(tile_row)] = { 32'd0, 1'd0, 1'd0, 1'd0 };
      tiles__recv_data_on_boundary_east__msg[1'(tile_row)] = { 32'd0, 1'd0, 1'd0, 1'd0 };
    end
  end
  ...
  always_ff @(posedge clk) begin : counter_logic
    if ( reset ) begin
      ...
      if ( cmd_e_count == 2'( __const__tile_count_sub_at_counter_logic ) ) begin
        cmd_e_count <= 2'd0;
      end
      else
        cmd_e_count <= cmd_e_count + 2'd1;
    end
  end
